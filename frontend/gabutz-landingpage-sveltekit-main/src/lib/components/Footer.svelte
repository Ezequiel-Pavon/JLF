	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-12">
				<p>
					Dibuat dengan <i class="bi bi-balloon-heart-fill"></i> oleh
  ...
  <div class="container p-4">
    <div class="row mt-4 text-start">
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
        ...
        <p>
          Contamos con más de 30 años de experiencia en el rubro, proveemos soluciones integrales en electricidad industrial y domiciliaria con productos de calidad.
        </p>
        <p>
    ...
    <br>
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
        <ul class="fa-ul" style="margin-left: 1.65em;">
          <li class="mb-3">
            <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Av. Calchaquí 4230, B1878 Quilmes</span>
          </li>
          <li class="mb-3">
            <span class="fa-li"><i class="fas fa-envelope"></i></span><span class="ms-2">info@electrojlf.com.ar</span>
          </li>
          <li class="mb-3">
            <span class="fa-li"><i class="fas fa-phone"></i></span><span class="ms-2">(011) 5353-9408 Lineas Rotativas</span>
          </li>
        </ul>
      </div>
      <!--Grid column-->
